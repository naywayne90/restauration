...
import { UtensilsCrossed, Menu, X, Phone, Mail, MapPin } from "lucide-react"
...
const FOOTER_LINKS = [
  {
    title: "MILY'S Gourmet",
    links: [
      { label: "Accueil", to: "/gourmet" },
      { label: "Comment ça marche", to: "/gourmet/comment-ca-marche" },
      { label: "Pour les entreprises", to: "/gourmet/entreprises" },
      { label: "Contact", to: "/gourmet/contact" },
    ],
  },
  {
    title: "Accès rapide",
    links: [
      ...
      { label: "Demander une démo", to: "/gourmet/contact" },
    ],
  },
]
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-slate-400 max-w-sm mb-6">
                La solution de restauration d'entreprise en Côte d'Ivoire.
                Menus variés, livraison ponctuelle, gestion simplifiée.
              </p>
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>contact@milys-gourmet.ci</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center gap-4 md:flex-row md:justify-between">
            ...
            <div className="flex items-center gap-4">
              <span className="text-xs text-slate-500">Suivez-nous :</span>
